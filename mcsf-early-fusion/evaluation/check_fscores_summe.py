...
path = '../exp1/original_summe/results/split4'  # path to the json files with the computed importance scores for each epoch
...
with open(path + '/video_scores.txt', 'w') as outfile:
