...
class FC(nn.Module):
    def __init__(self, input_size, output_size=1):
        ...
        self.fc_dt3 = nn.Linear(input_size, output_size)
        self.fc_dt4 = nn.Linear(input_size, output_size)
        self.fc_dt5 = nn.Linear(input_size, output_size)
        self.fc_dt6 = nn.Linear(input_size, output_size)
...
if __name__ == '__main__':
    diff_attention = DifferenceAttention(dataset=PROCESSED_SUMME, input_size=1024, out_file = 'summe_diff_attention34')
