...
class VideoData(Dataset):
    def __init__(self, mode, split_index, dataset,motion_features= False):
        self.mode = mode
        self.name = dataset
        ...
        self.motion_splits_filename = ['data/splits/' + self.name + '_splits.json']
...
def get_difference_attention(dataset):
    if dataset == 'summe':
        ...
        return open_pickle_file('tvsum_diff_attention.pickle'), open_pickle_file('tvsum_places365_attention.pickle')
    else:
        return None
