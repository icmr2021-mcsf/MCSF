...
split_num=0
path = '../exp1/tvsum_non_overlapping/split{}'.format(split_num)  # path to the json files with the computed importance scores for each epoch

results = listdir(path)
results.sort(key=lambda video: int(video[6:-5]))
PATH_TVSum = '../../data/TVSum/processed/eccv16_dataset_tvsum_google_pool5.h5'
