...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--m', help='the number of divisions used for chunk and stride network', type=int, default=4)
    parser.add_argument('--motion_feaures', help='use motion features (flow and rgb)',  type=str2bool, default='true')
    # load epoch
