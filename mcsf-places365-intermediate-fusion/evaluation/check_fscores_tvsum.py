...
split_num=0
path = '../exp1/tvsum_non-overlapping-with-attention-and-slowstart15/results/split{}'.format(split_num)  # path to the json files with the computed importance scores for each epoch
